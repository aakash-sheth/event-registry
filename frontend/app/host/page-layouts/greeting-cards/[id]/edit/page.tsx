...
export default function EditGreetingCardSamplePage(): React.ReactElement {
  ...
  function addTextBox(): void {
    const newBox: TextBox = {
      id: makeId(), text: 'Placeholder text', x: 10, y: 20, width: 80, height: null,
  ...
  return (
    <div className="min-h-screen bg-eco-beige flex flex-col">
      ...
      {error && <div className="bg-red-50 border-b border-red-200 px-6 py-2 text-sm text-red-600 flex-shrink-0">{error}</div>}
