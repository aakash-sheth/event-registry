...
SES_FROM_EMAIL = os.environ.get('SES_FROM_EMAIL', 'noreply@weddingregistry.com')

# SendGrid
SENDGRID_API_KEY = os.environ.get('SENDGRID_API_KEY', '')
SENDGRID_FROM_EMAIL = os.environ.get('SENDGRID_FROM_EMAIL', 'noreply@weddingregistry.com')
