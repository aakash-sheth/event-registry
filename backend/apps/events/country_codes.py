"""
Comprehensive list of ISO 3166-1 alpha-2 country codes and their phone country codes
Based on ITU-T E.164 international numbering plan
"""

# ISO 3166-1 alpha-2 to phone country code mapping
COUNTRY_CODES = {
    'AD': '+376',  # Andorra
...
# Reverse mapping: phone code to ISO codes (for multiple countries with same code)
PHONE_TO_ISO = {}
for iso, phone in COUNTRY_CODES.items():
    if phone not in PHONE_TO_ISO:
        PHONE_TO_ISO[phone] = []
    PHONE_TO_ISO[phone].append(iso)
